...
def create_project():
  """
      ...
      responses:
        ...
        400:
          description: Missing required field or the body isn\'t application/json
        409:
          description: The Project with te provided name already exists for the User ID.
        500:
...
def update_project_by_id(project_id):
  ...
  try:
    ...
    project.location_id = request.json['location_id'] if 'location_id' in request.json else project.location_id

    db.session.commit()

    project_updated = Project.query.get(project_id)
...
def get_projects_by_user():
  """
      ...
      responses:
        ...
        500:
          description: Database error or user_id not founded in token
  """
  try:
    ...
    return jsonify({'message': kerr}), 404
